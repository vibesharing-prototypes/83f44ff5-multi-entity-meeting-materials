        ...
        {activeItem ? (
          <div className="flex items-start gap-2.5">
            ...
            <div className="min-w-0">
              <p className="text-xs font-medium text-slate-700 leading-snug">{activeItem.title}</p>
              <p className="text-[11px] text-slate-400 mt-0.5 leading-snug">{activeItem.description}</p>
            </div>
          </div>
        ) : (
