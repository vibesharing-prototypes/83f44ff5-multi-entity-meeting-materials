  ...
  switch (type) {
    case 'cover':
      return (
        <div className="flex flex-col items-center justify-center text-center py-16 gap-5">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-800 uppercase tracking-wide">{entity.name}</p>
            <p className="text-sm text-slate-400 mt-1">Board of Directors</p>
          </div>
          <div className="w-px h-8 bg-slate-200" />
          <div>
            <p className="text-xl font-semibold text-slate-700">Board Pack · Q1 2026</p>
    ...
    case 'agenda':
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Board Meeting Agenda</h2>
    ...
    case 'minutes':
      return (
        <div className="space-y-5">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Minutes of Board Meeting</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={num}>
                <p className="text-sm font-semibold text-slate-800">{num} {title}</p>
    ...
    case 'letter':
      return (
        <div className="space-y-5 text-sm">
          ...
          <p className="font-semibold text-slate-800 text-base">Dear Board Members,</p>
    ...
    case 'report':
      return (
        <div className="space-y-5">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Chief Executive's Report</h2>
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 leading-relaxed">Revenue for Q4 2025 was £12.4m, exceeding budget by £0.5m (4%). EBITDA margin improved to 22.6%, up from 19.8% in Q3 2025. The quarter saw strong new business performance and the successful delivery of the technology migration programme.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 leading-relaxed">The technology migration programme completed on schedule in November. All legacy systems have been decommissioned and the new platform is operating at full capacity. The programme was delivered on time and within the approved budget of £1.8m.</p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-slate-800 mb-2">Outlook for Q1 2026</h3>
            <p className="text-sm text-slate-600 leading-relaxed">The pipeline remains strong. We expect Q1 2026 revenue to be in the range of £11.8m–£12.6m, in line with full-year budget. Key strategic priorities for the quarter are the banking facility renewal and the director appointment process.</p>
          </div>
        </div>
      )
    ...
    case 'financial':
      return (
        <div className="space-y-5">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Q4 Financial Statements</h2>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-slate-700">
              ...
              <tr className="border-t-2 border-slate-300">
                <td className="pt-2 font-bold text-slate-800">EBITDA</td>
    ...
    case 'risk':
      return (
        <div className="space-y-5">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Risk & Compliance Report</h2>
            <p className="text-sm text-slate-400">Quarter ended 31 December 2025</p>
          </div>
          <div className="h-px bg-slate-100" />
          <div className="space-y-4">
            {[
              { level: 'HIGH', dot: 'bg-red-500', border: 'border-red-200 bg-red-50', badge: 'text-red-700 bg-red-100', title: 'Regulatory Risk — EU AI Act', body: 'The EU AI Act requires compliance review of all AI-enabled products by Q2 2026. A compliance working group has been established and external legal counsel engaged. Board approval is required for the remediation budget of £240k. Action: Board to approve budget at this meeting.' },
              { level: 'MED', dot: 'bg-amber-500', border: 'border-amber-200 bg-amber-50', badge: 'text-amber-700 bg-amber-100', title: 'Operational Risk — Supplier Concentration', body: 'Cloud infrastructure is hosted exclusively with a single provider, representing a concentration risk. An RFP for a secondary provider is in progress, with selection expected by end of Q1 2026. Estimated cost of dual-provider arrangement: £80k p.a.' },
              { level: 'MED', dot: 'bg-amber-500', border: 'border-amber-200 bg-amber-50', badge: 'text-amber-700 bg-amber-100', title: 'Financial Risk — FX Exposure', body: 'EUR-denominated contracts represent £3.2m of annual revenue. Current hedging policy does not cover this exposure. CFO is reviewing hedging options; a proposal will be presented at the Q2 board meeting.' },
              { level: 'LOW', dot: 'bg-emerald-500', border: 'border-emerald-200 bg-emerald-50', badge: 'text-emerald-700 bg-emerald-100', title: 'Reputational Risk', body: 'Social media monitoring is in place via third-party provider. No adverse incidents were recorded in Q4 2025. Brand sentiment score: 74/100 (stable).' },
    ...
    case 'resolution':
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Resolutions for Approval</h2>
    ...
    case 'aob':
      return (
        <div className="space-y-5">
          <div>
            <h2 className="text-base font-bold text-slate-800 uppercase tracking-wide">Any Other Business</h2>
    ...
    <div className={`flex ${isUser ? 'justify-end' : 'justify-start'}`}>
      <div
        className={`max-w-[85%] px-3 py-2 rounded-lg text-xs leading-relaxed ${
          isUser ? 'bg-slate-800 text-white rounded-br-sm' : 'bg-slate-100 text-slate-700 rounded-bl-sm'
        }`}
      >
        {message.content}
      </div>
...
export default function DocumentEditor({
  ...
  return (
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      ...
      {/* Top navigation bar */}
      <header className="flex-shrink-0 flex items-center justify-between px-6 py-3 border-b border-slate-200 bg-white">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <svg className="w-3 h-3 text-slate-300 flex-shrink-0" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M4 2l4 4-4 4" />
          </svg>
          <span className="text-xs font-medium text-slate-700 truncate">{section.title}</span>
          {hasUnsaved && (
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <span className="text-xs text-slate-400 tabular-nums">{sectionIndex + 1} / {SECTIONS.length}</span>
          <button
            onClick={() => {
              if (hasUnsaved && !window.confirm('Discard unsaved changes before switching sections?')) return
              router.push(`/entity/${entity.id}/edit/${sectionIndex + 1}`)
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-slate-100 p-8">
          <div
            ...
            className="max-w-3xl mx-auto bg-white shadow-sm rounded-xl p-10 min-h-[700px] outline-none focus:ring-2 focus:ring-blue-200 focus:ring-offset-4 cursor-text transition-shadow"
          >
        ...
        <aside className="w-80 flex-shrink-0 border-l border-slate-200 flex flex-col bg-white">
          <div className="px-4 py-3 border-b border-slate-200 flex-shrink-0">
            <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">AI Assistant</h2>
            <p className="text-[11px] text-slate-400 mt-0.5">Editing: {section.title}</p>
          </div>
      ...
      {/* Sticky footer */}
      <footer className="flex-shrink-0 border-t border-slate-200 bg-white px-6 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={!hasUnsaved}
            className="px-4 py-2 text-xs font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            Discard
          </button>
          <button
